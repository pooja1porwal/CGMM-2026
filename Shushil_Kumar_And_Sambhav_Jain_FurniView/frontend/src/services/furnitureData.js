/**
 * Comprehensive 10-item Furniture Collection Dataset
 * Used for both seed database and instant zero-dependency client fallback.
 */
export const defaultFurnitureList = [
  {
    _id: 'furn-sofa-1',
  ...
  },
  {
    ...
    defaultAccessories: {
      ...
      blanket: true,
      pillows: true,
      bedsheetColor: '#ffffff',
      blanketColor: '#8b5cf6',
      pillowColor: '#f59e0b',
    },
  },
  {
    _id: 'furn-office-chair-6',
